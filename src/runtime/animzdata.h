...
enum Animz
{
    ...
    ANIMZ_BABYDRAGON          = 0xb2,
    ANIMZ_BABYDRAGON_2        = 0xb3,
    ANIMZ_BABYDRAGON_3        = 0xb4,
    ANIMZ_BABYDRAGON_4        = 0xb5,
    ANIMZ_BABYDRAGON_5        = 0xb6,
    ANIMZ_BABYDRAGON_6        = 0xb7,
    ANIMZ_BABYDRAGON_7        = 0xb8,
    ANIMZ_BABYDRAGON_8        = 0xb9,
    ANIMZ_BABYDRAGON_FRONT    = 0xba,
    ANIMZ_BABYDRAGON_FRONT_2  = 0xbb,
    ANIMZ_BABYDRAGON_FRONT_3  = 0xbc,
    ANIMZ_BABYDRAGON_FRONT_4  = 0xbd,
    ANIMZ_BABYDRAGON_FRONT_5  = 0xbe,
    ANIMZ_BABYDRAGON_FRONT_6  = 0xbf,
    ANIMZ_BABYDRAGON_FRONT_7  = 0xc0,
    ANIMZ_BABYDRAGON_FRONT_8  = 0xc1,
    ANIMZ_BABYDRAGON_LEFT     = 0xc2,
    ANIMZ_BABYDRAGON_LEFT_2   = 0xc3,
    ANIMZ_BABYDRAGON_LEFT_3   = 0xc4,
    ANIMZ_BABYDRAGON_LEFT_4   = 0xc5,
    ANIMZ_BABYDRAGON_LEFT_5   = 0xc6,
    ANIMZ_BABYDRAGON_LEFT_6   = 0xc7,
    ANIMZ_BABYDRAGON_LEFT_7   = 0xc8,
    ANIMZ_BABYDRAGON_LEFT_8   = 0xc9,
    ANIMZ_BABYDRAGON_RIGHT    = 0xca,
    ANIMZ_BABYDRAGON_RIGHT_2  = 0xcb,
    ANIMZ_BABYDRAGON_RIGHT_3  = 0xcc,
    ANIMZ_BABYDRAGON_RIGHT_4  = 0xcd,
    ANIMZ_BABYDRAGON_RIGHT_5  = 0xce,
    ANIMZ_BABYDRAGON_RIGHT_6  = 0xcf,
    ANIMZ_BABYDRAGON_RIGHT_7  = 0xd0,
    ANIMZ_BABYDRAGON_RIGHT_8  = 0xd1,
    ANIMZ_EGG_DRAGON          = 0xd2,
    ANIMZ_EGG_DRAGON_2        = 0xd3,
    ANIMZ_EGG_DRAGON_3        = 0xd4,
    ANIMZ_EGG_DRAGON_4        = 0xd5,
    ANIMZ_EGG_DRAGON_5        = 0xd6,
    ANIMZ_EGG_DRAGON_6        = 0xd7,
    ANIMZ_EGG_DRAGON_7        = 0xd8,
    ANIMZ_EGG_DRAGON_8        = 0xd9,
    ...
    ANIMZ_BABYDRAGON_LEN      = 0x08,
    ANIMZ_BABYDRAGON_FRONT_LEN = 0x08,
    ANIMZ_BABYDRAGON_LEFT_LEN = 0x08,
    ANIMZ_BABYDRAGON_RIGHT_LEN = 0x08,
    ANIMZ_EGG_DRAGON_LEN      = 0x08,
    ANIMZ_TOTAL_COUNT         = 0xda,
};
