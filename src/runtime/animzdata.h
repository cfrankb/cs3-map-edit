...
enum Animz
{
    ...
    ANIMZ_FIREBALL_SM         = 0x73,
    ANIMZ_FIREBALL_SM_2       = 0x74,
    ANIMZ_FIREBALL_SM_3       = 0x75,
    ANIMZ_FIREBALL_SM_4       = 0x76,
    ...
    ANIMZ_BBDRAGONDN          = 0xba,
    ANIMZ_BBDRAGONDN_2        = 0xbb,
    ANIMZ_BBDRAGONDN_3        = 0xbc,
    ANIMZ_BBDRAGONDN_4        = 0xbd,
    ANIMZ_BBDRAGONDN_5        = 0xbe,
    ANIMZ_BBDRAGONDN_6        = 0xbf,
    ANIMZ_BBDRAGONDN_7        = 0xc0,
    ANIMZ_BBDRAGONDN_8        = 0xc1,
    ANIMZ_BBDRAGONLF          = 0xc2,
    ANIMZ_BBDRAGONLF_2        = 0xc3,
    ANIMZ_BBDRAGONLF_3        = 0xc4,
    ANIMZ_BBDRAGONLF_4        = 0xc5,
    ANIMZ_BBDRAGONLF_5        = 0xc6,
    ANIMZ_BBDRAGONLF_6        = 0xc7,
    ANIMZ_BBDRAGONLF_7        = 0xc8,
    ANIMZ_BBDRAGONLF_8        = 0xc9,
    ANIMZ_BBDRAGONRG          = 0xca,
    ANIMZ_BBDRAGONRG_2        = 0xcb,
    ANIMZ_BBDRAGONRG_3        = 0xcc,
    ANIMZ_BBDRAGONRG_4        = 0xcd,
    ANIMZ_BBDRAGONRG_5        = 0xce,
    ANIMZ_BBDRAGONRG_6        = 0xcf,
    ANIMZ_BBDRAGONRG_7        = 0xd0,
    ANIMZ_BBDRAGONRG_8        = 0xd1,
    ANIMZ_EGG_HATCH           = 0xd2,
    ANIMZ_EGG_HATCH_2         = 0xd3,
    ANIMZ_EGG_HATCH_3         = 0xd4,
    ANIMZ_EGG_HATCH_4         = 0xd5,
    ANIMZ_EGG_HATCH_5         = 0xd6,
    ANIMZ_EGG_HATCH_6         = 0xd7,
    ANIMZ_EGG_HATCH_7         = 0xd8,
    ANIMZ_EGG_HATCH_8         = 0xd9,
    ...
    ANIMZ_BBDRAGONDN_LEN      = 0x08,
    ANIMZ_BBDRAGONLF_LEN      = 0x08,
    ANIMZ_BBDRAGONRG_LEN      = 0x08,
    ANIMZ_EGG_HATCH_LEN       = 0x08,
